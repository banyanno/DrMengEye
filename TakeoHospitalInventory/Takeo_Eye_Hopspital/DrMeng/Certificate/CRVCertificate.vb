...
Public Class CRVCertificate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.CRVCertificate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVCertificate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVCertificate = New CRVCertificate
        rpt.Site = Me.Site
        Return rpt
    End Function
