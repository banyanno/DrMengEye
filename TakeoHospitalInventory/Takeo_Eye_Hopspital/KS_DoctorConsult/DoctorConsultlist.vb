...
Public Class DoctorConsultlist
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.DoctorConsultlist.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedDoctorConsultlist
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As DoctorConsultlist = New DoctorConsultlist
        rpt.Site = Me.Site
        Return rpt
    End Function
