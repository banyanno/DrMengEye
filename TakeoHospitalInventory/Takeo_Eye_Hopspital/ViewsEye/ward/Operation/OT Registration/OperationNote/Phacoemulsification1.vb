...
Public Class Phacoemulsification1
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Phacoemulsification1.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.Phacoemulsification1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPhacoemulsification1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Phacoemulsification1 = New Phacoemulsification1
        rpt.Site = Me.Site
        Return rpt
    End Function
