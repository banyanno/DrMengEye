...
Public Class Trabeculectomy1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.Trabeculectomy1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTrabeculectomy1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Trabeculectomy1 = New Trabeculectomy1
        rpt.Site = Me.Site
        Return rpt
    End Function
