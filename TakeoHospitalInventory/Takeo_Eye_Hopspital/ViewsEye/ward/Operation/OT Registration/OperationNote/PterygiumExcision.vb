...
Public Class PterygiumExcision
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.PterygiumExcision.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPterygiumExcision
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PterygiumExcision = New PterygiumExcision
        rpt.Site = Me.Site
        Return rpt
    End Function
