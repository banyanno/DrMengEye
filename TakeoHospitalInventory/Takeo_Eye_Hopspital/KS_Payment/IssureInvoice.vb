...
Public Class IssureInvoice
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "TakeoHospitalInventory.IssureInvoice.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedIssureInvoice
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As IssureInvoice = New IssureInvoice
        rpt.Site = Me.Site
        Return rpt
    End Function
