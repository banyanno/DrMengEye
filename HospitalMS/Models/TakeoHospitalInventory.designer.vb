...
Partial Public Class tblItem
	...
	<Column(Storage:="_ItemCode", DbType:="NVarChar(100)")>  _
	...
	<Column(Storage:="_CateID", DbType:="Int")>  _
	...
	<Column(Storage:="_ItemDescription", DbType:="NVarChar(250)")>  _
	...
	<Column(Storage:="_ItemRegisterDate", DbType:="DateTime")>  _
	...
	<Column(Storage:="_DonatorID", DbType:="Int")>  _
	...
	<Column(Storage:="_IsMedicine", DbType:="Bit")>  _
	...
	<Column(Storage:="_CurrencyID", DbType:="Decimal(18,0)")>  _
	...
	<Column(Storage:="_DateExpired", DbType:="DateTime")>  _
	...
	<Column(Storage:="_CountryID", DbType:="Decimal(18,0)")>  _
...
Partial Public Class CARITAS_REQ_ITEM_PROVIDER_INFO
	...
	<Column(Storage:="_CostInUSD", DbType:="Decimal(18,2)")>  _
	...
	<Column(Storage:="_TotalCost", DbType:="Decimal(18,2)")>  _
