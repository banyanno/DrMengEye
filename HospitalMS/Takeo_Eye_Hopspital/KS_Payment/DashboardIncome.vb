...
Public Class DashboardIncome
    ...
    Private Sub GridIncome_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridIncome.SelectionChanged
        Try
            GridService.DataSource = DA_InvoiceDetail.SelectByInvoiceNo(GridIncome.GetRow.Cells("INVOICE_ID").Value)
            GridPrescription.DataSource = DA_Prescription.SelectByWaitingID(GridIncome.GetRow.Cells("WAITING_ID").Value)
        Catch ex As Exception
