...
Public Class CRVTotalSurgery
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "HospitalMS.CRVTotalSurgery.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCRVTotalSurgery
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CRVTotalSurgery = New CRVTotalSurgery
        rpt.Site = Me.Site
        Return rpt
    End Function
