Public Class DashboardPatientHistory
    ...
    Private Sub BtnFind_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnFind.Click
        If RadPatientNo.Checked = True Then
            GridPatientInformation.DataSource = DA_Patient.SelectByPatientNo(EmptyString(TxtPatientNo.Text))
        ElseIf RadPatientName.Checked = True Then
            GridPatientInformation.DataSource = DA_Patient.SelectByPatientName("%" & TxtPatientName.Text & "%")
        ElseIf RadTelephone.Checked = True Then
            GridPatientInformation.DataSource = DA_Patient.SelectByPatientPhone("%" & TxtTelephone.Text & "%")
        End If
    End Sub
    ...
    Private Sub GridPatientInformation_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridPatientInformation.SelectionChanged
        ...
        PictureBox1.Image = ByteArrayToImage(DAPatient.SelectPicture(GridPatientInformation.GetRow.Cells("PatientNo").Value))
        ViewPatientHistory(GridPatientInformation.GetRow.Cells("PatientNo").Value)
        ShowOperationHistory(GridPatientInformation.GetRow.Cells("PatientNo").Value)
    End Sub
    ...
    Private Sub GridHistoy_SelectionChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridHistoy.SelectionChanged
        ...
        If GridHistoy.SelectedItems.Count = 0 Then
            ...
            Exit Sub
        Else
            ViewConsultDetail(GridHistoy.GetRow.Cells("WAIT_ID").Value)
    ...
    End Sub
    Private Sub ViewConsultDetail(ByVal WaitingID)
        Try
            'It VA
            Dim tblVA As DataTable = DA_VA.SelectVAByWaitingID(WaitingID)
            For Each rows As DataRow In tblVA.Rows
                TxtRE1.Text = rows("RE")
                TxtRPh1.Text = rows("RPH")
                TxtREF1.Text = rows("RREF")
                TxtRRe1.Text = rows("RRE")

                TxtLe1.Text = rows("LE")
                TxtLPh1.Text = rows("LPH")
                TxtLRef1.Text = rows("LREF")
                TxtLLe1.Text = rows("LLE")
                TxtIOPRE.Text = IIf(IsDBNull(rows("IOPRE")) = True, "", rows("IOPLE"))
                TxtIOPLE.Text = IIf(IsDBNull(rows("IOPLE")) = True, "", rows("IOPLE"))
                TxtHistory.Text = rows("VA_NOTE")
            Next
    ...
    Private Sub BtnPrintHistory_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnPrintHistory.Click
        If GridPatientInformation.SelectedItems.Count = 0 Then Exit Sub
        Dim FHistory As New FormReportHistory
        FHistory.TxtPatientNo.Text = GridPatientInformation.GetRow.Cells("PatientNo").Value
        FHistory.ShowDialog()
    End Sub

    Private Sub BtnUpdateConsult_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BtnUpdateConsult.Click
        If GridHistoy.SelectedItems.Count = 0 Then Exit Sub
        Dim UpdateDRConsult As New NewDoctorConsult
        UpdateDRConsult.LblConsult.Text = GridHistoy.GetRow.Cells("CONSULT_ID").Value
        UpdateDRConsult.LblWaitingNo.Text = GridHistoy.GetRow.Cells("WAIT_ID").Value
        UpdateDRConsult.TxtPatientNo.Text = GridPatientInformation.GetRow.Cells("PatientNo").Value
        UpdateDRConsult.TxtNameEng.Text = GridPatientInformation.GetRow.Cells("NameEng").Value
        UpdateDRConsult.TxtNameKhmer.Text = GridPatientInformation.GetRow.Cells("NameKhmer").Value
        UpdateDRConsult.TxtAgePatient.Text = GridPatientInformation.GetRow.Cells("Age").Value
        UpdateDRConsult.CboSexPatien.Text = GridPatientInformation.GetRow.Cells("Sex").Value
        UpdateDRConsult.TxtTel.Text = GridPatientInformation.GetRow.Cells("Telephone").Value
        UpdateDRConsult.PictureBox1.Image = ByteArrayToImage(DAPatient.SelectPicture(GridPatientInformation.GetRow.Cells("PatientNo").Value))
        UpdateDRConsult.IS_UPDATE_CONSULT = True
        ' ++++++++++++++++++++++++ VA Info ============================
        'It VA
        UpdateDRConsult.TxtRE.Text = TxtRE1.Text ' GridHistoy.GetRow.Cells("RE").Value
        UpdateDRConsult.TxtRPh.Text = TxtRPh1.Text 'GridHistoy.GetRow.Cells("RPH").Value
        UpdateDRConsult.TxtRREF.Text = TxtREF1.Text ' GridHistoy.GetRow.Cells("RREF").Value
        UpdateDRConsult.TxtRRE.Text = TxtRRe1.Text 'GridHistoy.GetRow.Cells("RRE").Value

        UpdateDRConsult.TxtLE.Text = TxtLe1.Text 'GridHistoy.GetRow.Cells("LE").Value
        UpdateDRConsult.TxtLPh.Text = TxtLPh1.Text ' GridHistoy.GetRow.Cells("LPH").Value
        UpdateDRConsult.TxtLREF.Text = TxtLRef1.Text ' GridHistoy.GetRow.Cells("LREF").Value
        UpdateDRConsult.TxtLLE.Text = TxtLLe1.Text ' GridHistoy.GetRow.Cells("LLE").Value

        UpdateDRConsult.TxtHistory.Text = TxtHistory.Text ' GridHistoy.GetRow.Cells("VA_NOTE").Value
        ...
        '=================== View Patient Diagnosis, Prescription,Image,and Followup=============================
        UpdateDRConsult.ViewConsultForUpdate(GridHistoy.GetRow.Cells("WAIT_ID").Value)
        If UpdateDRConsult.ShowDialog = DialogResult.OK Then
            ViewPatientHistory(GridPatientInformation.GetRow.Cells("PatientNo").Value)
